...
const TabsAndroid = () => {
    return (
        ...
        >
            ...
            <BottonTabAndroid.Screen name="Tab2Screen" options={{ title: 'Tab 2' }} component={Tab2Screen} />
...
const TabsIos = () => {
    return (
        ...
        >
            ...
            <BottonTabIos.Screen name="Tab2Screen" options={{ title: 'Tab 2' }} component={Tab2Screen} />
